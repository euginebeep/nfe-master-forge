...
const PremixCandidatosPage = lazy(() => import("./pages/regulatorio/PremixCandidatosPage"));
          ...
          <Suspense fallback={<LoadingSpinner fullPage />}>
            <Routes>
              ...
              <Route element={
                ...
                <Route path="/compras/notas-sem-xml" element={<ProtectedRoute minRole="operador"><Suspense fallback={<PageFallback />}><ErrorBoundary><ModuleGuard modulo="compras" moduloLabel="Compras"><NotasSemXmlPage /></ModuleGuard></ErrorBoundary></Suspense></ProtectedRoute>} />
                ...
                <Route path="/compras/mapa" element={<ProtectedRoute minRole="supervisor"><Suspense fallback={<PageFallback />}><ErrorBoundary><ModuleGuard modulo="compras" moduloLabel="Compras"><MapaCotacaoPage /></ModuleGuard></ErrorBoundary></Suspense></ProtectedRoute>} />
                <Route path="/compras/pedidos" element={<ProtectedRoute minRole="supervisor"><Suspense fallback={<PageFallback />}><ErrorBoundary><ModuleGuard modulo="compras" moduloLabel="Compras"><PedidosCompraPage /></ModuleGuard></ErrorBoundary></Suspense></ProtectedRoute>} />
                <Route path="/compras/pedidos/:id" element={<ProtectedRoute minRole="supervisor"><Suspense fallback={<PageFallback />}><ErrorBoundary><ModuleGuard modulo="compras" moduloLabel="Compras"><PedidoCompraDetailPage /></ModuleGuard></ErrorBoundary></Suspense></ProtectedRoute>} />
                ...
                <Route path="/regulatorio/premix-candidatos" element={<ProtectedRoute minRole="supervisor"><Suspense fallback={<PageFallback />}><ErrorBoundary><ModuleGuard modulo="producao" moduloLabel="Produção"><PremixCandidatosPage /></ModuleGuard></ErrorBoundary></Suspense></ProtectedRoute>} />
                ...
                <Route path="/vendas/notas-saida/:id/editar" element={<ProtectedRoute minRole="operador"><Suspense fallback={<PageFallback />}><ErrorBoundary><ModuleGuard modulo="fiscal" moduloLabel="Fiscal"><EmissorNFePage /></ModuleGuard></ErrorBoundary></Suspense></ProtectedRoute>} />
