...
const ALL_COLLECTIONS = [
  ...
  { key: "entidades", label: "Entidades — legacy local (backend já ativo)" },
  { key: "entidade_contatos", label: "Contatos — legacy local (backend já ativo)" },
  { key: "entidade_enderecos", label: "Endereços — legacy local (backend já ativo)" },
  ...
  { key: "notas_entrada", label: "NF-e Entrada (resumo simplificado)" },
  { key: "notas_entrada_itens", label: "NF-e Entrada — Itens (resumo)" },
  { key: "notas_fiscais", label: "NF-e Entrada (XML completo parseado)" },
  { key: "notas_fiscais_observacoes", label: "NF-e Entrada — Observações" },
  { key: "notas_fiscais_itens", label: "NF-e Entrada — Itens detalhados" },
  { key: "notas_fiscais_itens_impostos", label: "NF-e Entrada — Impostos por item" },
  { key: "notas_fiscais_itens_rastros", label: "NF-e Entrada — Rastros" },
  { key: "notas_fiscais_totais", label: "NF-e Entrada — Totais" },
  { key: "notas_fiscais_transporte", label: "NF-e Entrada — Transporte" },
  { key: "notas_fiscais_volumes", label: "NF-e Entrada — Volumes" },
  { key: "notas_fiscais_faturas", label: "NF-e Entrada — Faturas" },
  { key: "notas_fiscais_duplicatas", label: "NF-e Entrada — Duplicatas" },
  { key: "notas_fiscais_pagamentos", label: "NF-e Entrada — Pagamentos" },
  { key: "contas_pagar", label: "Contas a Pagar (gerado pela NF-e)" },
  { key: "importacao_logs", label: "Logs de Importação NF-e" },
