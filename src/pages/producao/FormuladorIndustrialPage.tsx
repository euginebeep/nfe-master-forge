...
// Lista de Fórmulas + Conversões UI
// ============================================================
...
import { 
  ...
  CheckCircle, XCircle, Clock, FileText, RefreshCw, Beaker
} from "lucide-react";
...
import { ConversoesUnidadesManager } from "@/components/formulador/ConversoesUnidadesManager";
    ...
    <div>
      ...
      <Tabs defaultValue="formulas" className="space-y-6">
        <TabsList>
          ...
          <TabsTrigger value="conversoes" className="gap-2">
