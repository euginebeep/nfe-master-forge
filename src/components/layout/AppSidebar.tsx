...
},
{
  ...
  { title: "Homologação ANVISA", url: "/qualidade/homologacao-anvisa", icon: ShieldCheck, tooltip: "Fila de insumos sem vínculo ANVISA — engine sugere, RT confirma ou corrige", modulo: "qualidade" },
