  ...
  return (
    <div ref={containerRef} className="op-doc" style={{ width: '100%' }}>
      <style>{`
        ...
        @media print{ .op-doc{ background:#fff; padding:0; } .op-doc .page{ width:210mm; min-height:297mm; padding:8mm; margin:0 auto; box-shadow:none; } .op-doc .op-toolbar{ display:none; } .op-doc .footer{ position:fixed; bottom:0; left:0; right:0; height:12mm; padding:0 8mm; display:flex; align-items:center; justify-content:space-between; font-size:6px; color:#8f887a; } }
      ...
      <div className="page">
        ...
        <div className="sec"><span className="n">2</span><h2>Registro de execução da mistura</h2><span className="cnt">tempo real por etapa</span></div>
      ...
      <div className="page">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 9, marginTop: 6 }}>
          <div className="grid c3"><div className="cell"><div className="k">Hora início</div><div className="v blank">____</div></div><div className="cell"><div className="k">Hora término</div><div className="v blank">____</div></div><div className="cell"><div className="k">Tempo total</div><div className="v blank">____</div></div><div className="cell"><div className="k">Produzidas</div><div className="v blank">____</div></div><div className="cell"><div className="k">Rejeitadas</div><div className="v blank">____</div></div><div className="cell"><div className="k">Aprovadas</div><div className="v blank">____</div></div></div>
          <div className="grid c2"><div className="cell"><div className="k">Planejada (+{perdas?.acrescimo_percentual ?? 5}%)</div><div className="v">{(perdas?.quantidade_com_acrescimo ?? totalCaps).toLocaleString('pt-BR')} un</div></div><div className="cell"><div className="k">Produzida</div><div className="v blank">____</div></div><div className="cell"><div className="k">Perda / %</div><div className="v blank">___ / __%</div></div><div className="cell"><div className="k">Rendimento</div><div className="v blank">____ %</div></div></div>
        </div>
        <div className="sec"><span className="n">3</span><h2>Amostra de retenção</h2><span className="cnt">RDC 243/2018 · BPF</span></div>
      ...
      <div className="page">
        ...
        <table><thead><tr><th className="c" style={{ width: '15px' }}>#</th><th>Material</th><th style={{ width: '92px' }}>Tipo</th><th className="num" style={{ width: '54px' }}>Necessária</th><th className="qc" style={{ width: '66px' }}>Lote</th><th className="qc c" style={{ width: '46px' }}>Qtd. usada</th><th className="qc" style={{ width: '70px' }}>Conferido por</th><th className="qc c" style={{ width: '15px' }}><span className="box" /></th></tr></thead>
          <tbody>{embalagens.map((e: any, i: number) => (<tr key={e.id}><td className="c">{i + 1}</td><td>{e.material_nome || e.insumo_nome}</td><td>{e.tipo || '—'}</td><td className="num">{e.quantidade_necessaria != null ? `${Number(e.quantidade_necessaria).toLocaleString('pt-BR')} un` : '—'}</td><td className="qc">{e.numero_lote || '—'}</td><td className="qc" /><td className="qc" /><td className="qc c" /></tr>))}</tbody></table>
