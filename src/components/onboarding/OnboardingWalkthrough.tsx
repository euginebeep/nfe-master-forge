...
const PASSOS = [
  ...
  },
  {
    ...
    descricao:
      'Sempre que tiver dúvidas, clique no botão azul ✨ no canto inferior direito. O Assistente BrainX responde qualquer pergunta em linguagem simples, 24 horas por dia.',
    rota: null,
